...
(function () {
  ...
  function authGuard() {
    ...
    const ok = ['MANAGER','PROJECT_MANAGER'].includes((u.role||'').toUpperCase());
  ...
  function buildSidebarHTML() {
    const links = [
      { group:'Main', items:[
        { href:'/project-manager/dashboard',      icon:'fa-home',               label:'Dashboard' },
        { href:'/project-manager/projects',       icon:'fa-folder-open',        label:'Projects',        badge:'badge-proj' },
        { href:'/project-manager/tasks',          icon:'fa-check-square',       label:'Tasks',           badge:'badge-task' },
        { href:'/project-manager/team',           icon:'fa-users',              label:'Team & Employees' },
      ]},
      { group:'Planning', items:[
        { href:'/project-manager/sprints',        icon:'fa-bolt',               label:'Sprint Board' },
        { href:'/project-manager/kanban',         icon:'fa-th-large',           label:'Kanban Board' },
        { href:'/project-manager/calendar',       icon:'fa-calendar-alt',       label:'Calendar' },
        { href:'/project-manager/timeline',       icon:'fa-stream',             label:'Timeline' },
        { href:'/project-manager/gantt',          icon:'fa-project-diagram',    label:'Gantt Chart' },
        { href:'/project-manager/meetings',       icon:'fa-video',              label:'Meetings',        badge:'badge-meet' },
      ]},
      { group:'Workforce', items:[
        { href:'/project-manager/hold-employees', icon:'fa-pause-circle',       label:'Hold Employees' },
        { href:'/project-manager/shift-history',  icon:'fa-history',            label:'Shift History' },
        { href:'/project-manager/attendance',     icon:'fa-clock',              label:'Attendance' },
      ]},
      { group:'Tracking', items:[
        { href:'/project-manager/daily-updates',  icon:'fa-clipboard-list',     label:'Daily Updates' },
        { href:'/project-manager/performance',    icon:'fa-chart-line',         label:'Performance' },
      ]},
      { group:'Collaborate', items:[
        { href:'/project-manager/chat',           icon:'fa-comments',           label:'Team Chat',       badge:'badge-chat' },
        { href:'/project-manager/documents',      icon:'fa-file-alt',           label:'Documents' },
      ]},
      { group:'Insights', items:[
        { href:'/project-manager/analytics',      icon:'fa-chart-bar',          label:'Analytics' },
        { href:'/project-manager/reports',        icon:'fa-file-invoice',       label:'Reports' },
        { href:'/project-manager/notifications',  icon:'fa-bell',              label:'Notifications',   badge:'badge-notif' },
      ]},
      { group:'System', items:[
        { href:'/project-manager/employee-profile',icon:'fa-id-card',           label:'Project Manager' },
        { href:'/project-manager/settings',       icon:'fa-cog',                label:'Settings' },
      ]},
    ];
      ...
      <aside class="pm-sidebar" id="pmSidebar">
        <div class="pm-sidebar-brand">
          ...
          <div class="pm-sidebar-brand-text">
            ...
            <div class="brand-role">Project Manager</div>
          </div>
        ...
        <div class="pm-sidebar-footer">
          <div class="pm-user-mini" onclick="window.pmShell?.confirmLogout()">
            <div class="pm-user-avatar" id="sidebarAvatar">PM</div>
            <div class="pm-user-info">
              <div class="pm-user-name"  id="sidebarUserName">Project Manager</div>
              <div class="pm-user-role"  id="sidebarUserDept">Department</div>
            </div>
            <i class="fa fa-sign-out-alt logout-btn" title="Logout"></i>
          </div>
        </div>
      </aside>`;
  }
    ...
    return `
      <header class="pm-header" id="pmHeader">
        ...
        <div class="pm-header-actions">
          ...
          <!-- Chat -->
          <div class="pm-icon-btn" title="Team Chat" onclick="window.location='/project-manager/chat'">
            <i class="fa fa-comment-dots"></i>
            <span class="notif-dot" id="headerChatDot" style="display:none"></span>
          </div>
          <!-- Calendar -->
          <div class="pm-icon-btn" title="Calendar" onclick="window.location='/project-manager/calendar'">
            <i class="fa fa-calendar-alt"></i>
          </div>
          <div class="pm-header-divider"></div>
          <!-- Profile -->
          <div class="pm-profile-btn" id="profileBtn" onclick="window.location='/project-manager/employee-profile'">
            <div class="pm-profile-avatar" id="headerAvatar">PM</div>
            <span class="pm-profile-name" id="headerUserName">PM</span>
  ...
  function injectExtraCSS() {
    ...
    style.textContent = `
      ...
      .pm-sidebar.collapsed .nav-badge,
      .pm-sidebar.collapsed .logout-btn { display: none; }
      ...
      .pm-sidebar-nav::-webkit-scrollbar { width: 6px; }
      .pm-sidebar-nav::-webkit-scrollbar-track { background: transparent; }
      .pm-sidebar-nav::-webkit-scrollbar-thumb {
        background: rgba(148,163,184,.45);
        border-radius: 999px;
      }
      .pm-sidebar-nav::-webkit-scrollbar-thumb:hover { background: rgba(148,163,184,.7); }
